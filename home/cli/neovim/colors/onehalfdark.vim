...
" Syntax colors
call  s:h("Whitespace",      s:comment_fg,  s:trans,      s:trans)
...
" nvim-cmp
call s:h("CmpItemAbbr", s:white, "", "")
call s:h("CmpItemAbbrMatch", s:blue, "", "")
call s:h("CmpItemAbbrMatchFuzzy", s:blue, "", "")
call s:h("CmpItemAbbrDeprecate", s:comment_fg, "", "")
call s:h("CmpItemKind", s:blue, "", "")
call s:h("CmpItemKindText", s:blue, "", "")
call s:h("CmpItemKindMethod", s:cyan, "", "")
call s:h("CmpItemKindFunction", s:cyan, "", "")
call s:h("CmpItemKindConstructor", s:purple, "", "")
call s:h("CmpItemKindField", s:green, "", "")
call s:h("CmpItemKindVariable", s:green, "", "")
call s:h("CmpItemKindClass", s:red, "", "")
call s:h("CmpItemKindInterface", s:blue, "", "")
call s:h("CmpItemKindModule", s:purple, "", "")
call s:h("CmpItemKindProperty", s:blue, "", "")
call s:h("CmpItemKindUnit", s:purple, "", "")
call s:h("CmpItemKindValue", s:cyan, "", "")
call s:h("CmpItemKindEnum", s:blue, "", "")
call s:h("CmpItemKindKeyword", s:red, "", "")
call s:h("CmpItemKindSnippet", s:cyan, "", "")
call s:h("CmpItemKindColor", s:yellow, "", "")
call s:h("CmpItemKindFile", s:white, "", "")
call s:h("CmpItemKindReference", s:blue, "", "")
call s:h("CmpItemKindFolder", s:yellow, "", "")
call s:h("CmpItemKindEnumMember", s:green, "", "")
call s:h("CmpItemKindConstant", s:red, "", "")
call s:h("CmpItemKindStruct", s:cyan, "", "")
call s:h("CmpItemKindEvent", s:blue, "", "")
call s:h("CmpItemKindOperator", s:blue, "", "")
call s:h("CmpItemKindTypeParameter", s:yellow, "", "")
call s:h("CmpItemMenu", s:white, "", "")
